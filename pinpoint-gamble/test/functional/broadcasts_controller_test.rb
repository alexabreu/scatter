...
class BroadcastsControllerTest < ActionController::TestCase
  ...
  test "should create broadcast" do
    assert_difference('Broadcast.count') do
      post :create, broadcast: { inside: @broadcast.inside, lat: @broadcast.lat, lng: @broadcast.lng, x: @broadcast.x, y: @broadcast.y }
    end
  ...
  test "should update broadcast" do
    put :update, id: @broadcast, broadcast: { inside: @broadcast.inside, lat: @broadcast.lat, lng: @broadcast.lng, x: @broadcast.x, y: @broadcast.y }
    assert_redirected_to broadcast_path(assigns(:broadcast))
  end
